...
class Config{
    ...
    */
    ...
    public static $servers = array(
        "COHRPV2" => array( // The name of the server (make unique)
            "ip" => "76.205.161.214", // The IP (if on something different to the one in the config)
            "fivemPort" => "30120", // The fivem port
            "socketPort" => "30123", // Set to the port that you set in the "socket_port" convar (if different to the one in the config)
            "liveMapName" => "live-map" // Set to the resource's name (if different to the one in the config)
        )
    );
